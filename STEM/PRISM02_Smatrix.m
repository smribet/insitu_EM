...
emdSTEM.PsiInit=emdSTEM.PsiInit.*exp((-1i*pi*emdSTEM.lambda*emdSTEM.probeDefocusC1)* emdSTEM.q2Interp + ...
         (1i*pi/2*emdSTEM.lambda^3*emdSTEM.cS)* emdSTEM.q2Interp.^2);
